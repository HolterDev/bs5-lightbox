...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "bootstrap/js/src/util/index", "bootstrap/js/src/dom/event-handler", "bootstrap/js/src/dom/manipulator", "bootstrap/js/src/dom/selector-engine", "bootstrap/js/src/base-component"], factory);
    }
    ...
    class Carousel extends base_component_1.default {
        ...
        nextWhenVisible() {
            ...
            if (!document.hidden && index_1.isVisible(this._element)) {
                this.next();
            }
        }
        prev() {
        ...
        pause(event) {
            ...
            if (selector_engine_1.default.findOne(SELECTOR_NEXT_PREV, this._element)) {
                index_1.triggerTransitionEnd(this._element);
                this.cycle(true);
            }
        ...
        _getConfig(config) {
            ...
            index_1.typeCheckConfig(NAME, config, DefaultType);
            return config;
        }
        _handleSwipe() {
        ...
        _getItemByOrder(order, activeElement) {
            ...
            return index_1.getNextActiveElement(this._items, activeElement, isNext, this._config.wrap);
        }
        ...
        static dataApiClickHandler(event) {
            let target = index_1.getElementFromSelector(this);
