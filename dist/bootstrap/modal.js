...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "bootstrap/js/src/util/index", "bootstrap/js/src/dom/event-handler", "bootstrap/js/src/dom/manipulator", "bootstrap/js/src/dom/selector-engine", "bootstrap/js/src/util/scrollbar", "bootstrap/js/src/base-component", "bootstrap/js/src/util/backdrop", "bootstrap/js/src/util/focustrap"], factory);
    }
    ...
    class Modal extends base_component_1.default {
        ...
        _adjustDialog() {
            ...
            if ((!isBodyOverflowing && isModalOverflowing && !index_1.isRTL()) || (isBodyOverflowing && !isModalOverflowing && index_1.isRTL())) {
